...
if __name__ == '__main__':
    ...
    data = np.genfromtxt('data/output.csv', delimiter=',', dtype=np.float32, skip_header=1)
    save_pcolormesh_to_jpg(data, 'data/output.jpg', x_label=x_label, y_label=y_label, z_label = z_label)
